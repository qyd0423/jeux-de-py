...
class snake(MyGame):
    def __init__(self):
        super(snake, self).__init__(GAME_NAME, SCREEN_SIZE, FPS,
                                    "C:\\Users\\qyd04\\Desktop\\tanchishe\\snake\\resourses\\MC.ttf", 25, "C:\\Users\\qyd04\\Desktop\\tanchishe\\snake\\resourses\\pysnake.png")  # 初始父类
    ...
    def show(self):
        ...
        if not self.snake.alive:
            ...
            l = 0
            for line in output:
                output = pygame.font.Font("C:\\Users\\qyd04\\Desktop\\tanchishe\\snake\\resourses\\MC.ttf", 16).render(line, True, BLACK)
